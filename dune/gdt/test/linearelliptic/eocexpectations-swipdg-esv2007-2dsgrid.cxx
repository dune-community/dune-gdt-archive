...
public:
  ...
  {
    if (type == "L2")
      return {1.13e-02, 2.90e-03, 7.41e-04, 1.88e-04}; // {1.15e-01, 3.04e-02, 7.51e-03, 1.86e-03};
    else if (type == "H1_semi" || type == "energy")
      return {2.77e-01, 1.39e-01, 6.98e-02, 3.50e-02}; // {3.79e-01, 1.90e-01, 9.38e-02, 4.67e-02};
    else
