  ...
  static std::vector< double > results(const TestCaseType& test_case, const std::string type)
  {
    if (type == "L2") {
      if (test_case.num_refinements() == 1)
        ...
        return {5.41e-02, 3.74e-02, 2.35e-02, 1.26e-02}; // {4.02e-02, 1.12e-02, 2.83e-03, 6.33e-04};
    } else if (type == "H1_semi" || type == "energy") {
      if (test_case.num_refinements() == 1)
        return {};
      else
        return {2.55e+00, 2.39e+00, 2.10e+00, 1.55e+00}; // {2.69e-01, 1.39e-01, 6.87e-02, 3.08e-02};
    } else
  ...
  static std::vector< double > results(const TestCaseType& test_case, const std::string type)
  {
    if (type == "L2") {
      if (test_case.num_refinements() == 1)
        ...
        return {4.91e-02, 3.38e-02, 2.09e-02, 1.04e-02};
    } else if (type == "H1_semi" || type == "energy") {
      if (test_case.num_refinements() == 1)
        return {2.59e+00, 2.45e+00, 2.17e+00, 1.56e+00};
      else
        return {};
    } else
      EXPECT_TRUE(false) << "test results missing for type: " << type;
